        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row justify-between">
                    ...
                    @role('owner')
                    <form action="{{ route('admin.fundraising_withdrawal.activate_fundraising', $fundraising) }}" method="POST">
                        @csrf
                ...
                <div class="flex flex-row justify-between items-center">
                    <div>
                        <h3 class="text-indigo-950 text-xl font-bold">Rp{{ number_format($fundraising->totalReachedAmount(), 0, ',', '.') }}</h3>
                ...
                <form method="POST" action="{{ route('admin.fundraising_withdrawal.store', $fundraising) }}" enctype="multipart/form-data">
                    @csrf
