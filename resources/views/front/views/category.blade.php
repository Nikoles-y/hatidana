...
@section('title', 'Explore Fundraising Categories')
@section('content')
<section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#FCF7F1] overflow-x-hidden pb-4">
    ...
    <div class="flex flex-col gap-4 px-4">
        ...
        @empty
        <p class="font-bold text-[18px] leading-[39px] text-black text-center">
            <span class='font-bold'>Belum ada fundraising tersedia pada kategori ini</span>
        </p>
        @endforelse
