        ...
        <div id="content" class="w-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_120px]">
            <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center gap-2">
                    <div class="w-9 h-9 flex shrink-0 rounded-full overflow-hidden">
                        <img src="{{ Storage::url($fundraising->fundraiser->user->avatar) }}" class="w-full h-full object-cover" alt="Profile">
                    </div>
            ...
            <div class="flex flex-col gap-[2px]">
                ...
                <p class="desc-less text-sm leading-[26px]">{{ $fundraising->about }}
                    <br>
                    <button class="text-[#FF7815] underline" onclick="toggleSeeMoreLess()">see more</button></p>
                <p class="desc-more text-sm leading-[26px] hidden">{{ $fundraising->about }}
                    <br>
                    <button class="text-[#FF7815] underline" onclick="toggleSeeMoreLess()">see less</button></p>
            </div>
